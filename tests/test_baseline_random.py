...
def run() -> results.Run:
    return baseline_random.rollout(SMALL, molecules.size_reward)
...
def test_the_same_seed_gives_the_same_rollout():
    ...
    first = baseline_random.rollout(SMALL, molecules.size_reward)
    second = baseline_random.rollout(SMALL, molecules.size_reward)
