...
def run() -> results.Run:
    return random_walk.rollout(SMALL, molecules.size_reward)
...
def test_the_same_seed_gives_the_same_rollout():
    ...
    first = random_walk.rollout(SMALL, molecules.size_reward)
    second = random_walk.rollout(SMALL, molecules.size_reward)
